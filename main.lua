...
import "config"
wz="https://ndhscript.000webhostapp.com/LoginNDH/"
import "http"
...
function image_logo_login.onClick()
  viewIntent = Intent("android.intent.action.VIEW",Uri.parse("https://youtube.com/channel/UCtkUGIevqQf5KkhjXDCuiFA"))
  activity.startActivity(viewIntent)
end
